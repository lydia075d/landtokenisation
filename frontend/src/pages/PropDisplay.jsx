...
export default function PropertyForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100 px-4 py-12">
          ...
          <div className="space-y-10">
            ...
            <div className="relative">
              ...
              <div className="space-y-3">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-red-400 hover:bg-red-50 transition-all duration-200 hover:shadow-md bg-white cursor-pointer">
                  <input
                    ref={generalFilesRef}
                    type="file"
                    multiple
